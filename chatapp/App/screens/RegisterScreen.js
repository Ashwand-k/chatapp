...
<SubmitButton title="Register"   color="buttoncolor" onLongPress={() =>navigation.navigate('AddDetails')}/>
{/* <AppButton title="chat " color= "secondary" mypress= {()=>{console.log('Welcome screen')}}  ></AppButton> */}
